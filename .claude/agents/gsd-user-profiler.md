...
<reference>
@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-profiling.md` to load:
