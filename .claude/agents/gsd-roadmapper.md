...
Reference full template: `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/state.md`.
