...
Use template from `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/UI-SPEC.md`
