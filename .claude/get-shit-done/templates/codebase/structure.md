...
- Usage: Reference from command with `@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/mniedre/git/docker-deploy/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/mniedre/git/docker-deploy/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
