...
```markdown
Read /Users/mniedre/git/docker-deploy/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/mniedre/git/docker-deploy/.claude/agents/gsd-ui-checker.md for instructions.
