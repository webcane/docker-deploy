...
INSTALL_JS_GLOBAL="/Users/mniedre/git/docker-deploy/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mniedre/git/docker-deploy/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
