...
```
Agent(
  prompt="Read /Users/mniedre/git/docker-deploy/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/VALIDATION.md`
