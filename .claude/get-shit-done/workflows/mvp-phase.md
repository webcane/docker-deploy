...
<required_reading>
@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-story-template.md
@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/spidr-splitting.md
@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
