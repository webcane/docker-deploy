...
Key references:
- @/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/mniedre/git/docker-deploy/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/mniedre/git/docker-deploy/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/mniedre/git/docker-deploy/.claude/get-shit-done/USER-PROFILE.md" "/Users/mniedre/git/docker-deploy/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/mniedre/git/docker-deploy/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/mniedre/git/docker-deploy/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/mniedre/git/docker-deploy/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/mniedre/git/docker-deploy/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/mniedre/git/docker-deploy/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/mniedre/git/docker-deploy/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/mniedre/git/docker-deploy/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/mniedre/git/docker-deploy/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/mniedre/git/docker-deploy/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/mniedre/git/docker-deploy/.claude/CLAUDE.md
```
