...
<template>
@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/mniedre/git/docker-deploy/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/mniedre/git/docker-deploy/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/mniedre/git/docker-deploy/.claude/get-shit-done/workflows/diagnose-issues.md
