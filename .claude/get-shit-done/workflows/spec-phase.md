...
```bash
INIT=$(node "/Users/mniedre/git/docker-deploy/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mniedre/git/docker-deploy/.claude/get-shit-done/templates/spec.md.
